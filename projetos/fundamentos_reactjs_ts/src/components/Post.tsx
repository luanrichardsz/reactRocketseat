...
export function Post({ post }: PostProps) {
    ...
    function deleteComment(commentToDelete: string){
        //Imutabilidade -> as variaveis nao sofrem mutação, nos criamos um novo valor (um novo espaço na memoria)
    ...
    return (
        ...
        <footer>
            <button className={styles.buttonSubmit} type='submit' disabled={isNewCommentEmpty}>
                Publicar
            </button>    
        </footer> 
        </form>
